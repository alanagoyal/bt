...
async fn run_eval_files_once(
    ...
    let mut attempt = run_eval_files_once_inner(
        base,
        language,
        runner_override.clone(),
        &js_runner,
    ...
    if !attempt.output.status.success() && show_js_runner_hint_on_failure {
